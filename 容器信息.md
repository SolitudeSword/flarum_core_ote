...
| 功能 | when | needs | 闭包位置 |
| --- | --- | --- | --- |
| 未知 | `Flarum\Discussion\Search\DiscussionSearcher` | `Flarum\Search\GambitManager` | `Flarum\Search\SearchServiceProvider::registerDiscussionGambits` |
...
## 扩展列表
### 未知
- abstract：`Flarum\Http\UrlGenerator`
- 闭包位置：`Flarum\Api\ApiServiceProvider::register`
